...
include_once '../Includes/TableClasses/Notice.php';
include_once '../Includes/TableClasses/User.php';
include_once '../Includes/TableClasses/News.php';
include_once '../Includes/TableFunctions/NoticePage.php';
...
$category = new NoticePage($db,$cat_page);


$result = $category->allNotices();
